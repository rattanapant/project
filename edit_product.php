...
<div class="data_center"><!-- ส่วนกลางของเว็บ -->
 ...
 ?>
    <tr>
      ...
      <td width="79%" height="25"><input name="txt_name" type="text" id="txt_name"  style="width: 70%;" value="<?=$rs['prd_name']?>"/>
    ...
    <tr>
      ...
      <td height="25"><input name="prd_link_line"  type="text"  id="prd_link_line"  style="width:70%;" value="<?=$rs['prd_link_line']?>"/>
          <span class="style2">*</span></td>
    </tr>
    <tr>
...
echo "<script>alert('กรุณากรอกราคาสินค้าให้ถูกต้องด้วยนะ')</script>"; exit();
	...
	$sql_update2 = mysqli_query($con,"UPDATE ".$product." SET "
							...
							." prd_name ='".$_POST['txt_name']."', 
								...
								prd_link_line ='".$_POST['prd_link_line']."', 
