...
$limit = 1;//$NUMMAX; // แสดงผลหน้าละกี่หัวข้อ
			  ...
			  if(!$result['prd_photo']==""){ ?>
						  ...
						  <h2><?php echo $result['prd_name']; ?></h2> 
								...
								-->
								  ...
								  <li style="padding: 10px; text-align:right; "> ราคา: <samp  style="color:red;">
									...
									<li style="padding: 10px; text-align:right; ">
                                        ...
                                        <a target="_blank"  class="txt_btn"  href="<?=$result['prd_link_line']?>"><img src="images/buy_16.png" width="16" height="16" border="0" /> สั่งซื้อสินค้า </a>
										
<input  class="txt_btn" name="button" type="button" id="b" value="ย้อนกลับ" onclick="(history.back())" />
...
<a target="_blank"  class="txt_btn"  href="<?=$result['prd_link_line']?>"> สั่งซื้อสินค้า </a>
 <a  class="txt_btn"  href="detail_product.php?id=<?=$result['prd_id']?>"> รายละเอียด </a>
