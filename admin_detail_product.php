...
<li><img src="images/buy_16.png" width="16" height="16" /> <samp style="color:red;">

<a target="_blank" href="<?=$result['prd_link_line']?>"><?=$result['prd_link_line']?></a></samp> </li>
...
?>
 <td align="left" valign="top" id="prd_bottom"><div id="prd_photo">
			...
			<li><img src="images/buy_16.png" width="16" height="16" border="0" /> <a target="_blank" href="<?=$result['prd_link_line']?>"><?=$result['prd_link_line']?></a> </li>
